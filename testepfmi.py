...
idf.idfobjects['SIMULATIONCONTROL'][0].Run_Simulation_for_Weather_File_Run_Periods = 'YES'
idf.newidfobject('EXTERNALINTERFACE',
                 Name_of_External_Interface='FunctionalMockupUnitExport')
for i in range(num_variables):
    idf.newidfobject('ENERGYMANAGEMENTSYSTEM:GLOBALVARIABLE',
                     Erl_Variable_1_Name='dummy%i' % i)
